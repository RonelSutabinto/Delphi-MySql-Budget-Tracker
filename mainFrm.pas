...
type
  TmainForm = class(TForm)
    ...
    Label7: TLabel;
    userType_L: TLabel;
    NxOptionButton7: TNxOptionButton;
    ...
    procedure NxOptionButton7Click(Sender: TObject);
  private
...
uses
  ...
  procurementProcessingChart, logFrm, appFrm, data;
...
procedure TmainForm.NxOptionButton7Click(Sender: TObject);
begin
