...
begin
    ...
    begin
      ...
      userForm.usersQiddepartment.AsInteger := dataproc.departmentQiddepartment.AsInteger;

    end
    else if formStrFilter = 'appForm' then
    begin
      appForm.appQdeptCode.Text   := dataproc.departmentQdepartmentCode.Text;
      appForm.appQdepartment.Text := dataproc.departmentQdepartment.Text;
      appForm.appQidDepartment.AsInteger := dataproc.departmentQiddepartment.AsInteger;
    end;
