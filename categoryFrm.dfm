object categoryForm: TcategoryForm
  ...
  object category: TMyQuery
    Connection = dataproc.MyConnection1
    SQL.Strings = (
      'Select * from itemcategory')
    Left = 104
    Top = 280
    object categoryiditemcategory: TIntegerField
      FieldName = 'iditemcategory'
    end
    object categorycategory: TStringField
      FieldName = 'category'
      Size = 55
    end
  end
