object itemIndexForm: TitemIndexForm
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'itemIndexForm'
  ClientHeight = 411
  ClientWidth = 704
  Color = clBtnFace
  ...
  object itemIndexQ: TMyQuery
    Connection = dataproc.MyConnection1
    SQL.Strings = (
      'Select * from itemindex')
    Left = 64
    Top = 344
    object itemIndexQiditemIndex: TIntegerField
      FieldName = 'iditemIndex'
    end
    object itemIndexQcode: TStringField
      FieldName = 'code'
      Size = 25
    end
    object itemIndexQDescription: TStringField
      FieldName = 'Description'
      Size = 65
    end
    object itemIndexQunit: TStringField
      FieldName = 'unit'
      Size = 25
    end
    object itemIndexQcategory: TStringField
      FieldName = 'category'
      Size = 55
    end
    object itemIndexQtype: TStringField
      FieldName = 'type'
      Size = 45
    end
  end
  object itemIndexDS: TMyDataSource
    DataSet = itemIndexQ
    Left = 104
    Top = 344
  end
